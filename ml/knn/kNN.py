...
def classify0(inX, dataSet, labels, k):    
    ...
    #print 'predict distances=',sqDistances
    ...
    #print 'predict sortedClassCount=',sortedClassCount
    return sortedClassCount[0][0]

    
def randomArray(group,labels):
    perm = random.permutation(group.shape[0])
    labels=array(labels)
    group = group[perm]
    labels = labels[perm]
...
def file2matrix(filename,seperator='\t'):
    ...
    returnMat = zeros((numberOfLines,numField-1))    
